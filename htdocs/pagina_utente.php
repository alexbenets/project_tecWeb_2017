<?php 
	...
	$_SESSION['page']="utente.php";
	
	/* controllo se ho effettuato l'accesso */
	$datiUtente = leggi_utente(); /*non disponibile, ma ricavabile con le query di Al*/
	$link_prenotazione='<a href="login.php">Accedi</a>';
	$step=0;
	if(isset($_GET['step'])){
		$step=$_GET['step'];
	}
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="it" xml:lang="it">
	...
	<div id="header">
			...
			<div id="path"><a id="help" href="#content">salta navigazione</a>
				<span>Ti trovi in: </span><span><a href="index.html">Home</a></span>
				<span>Home</span>
			</div><!-- chiudo path-->
